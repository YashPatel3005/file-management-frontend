    ...
    <>
      <div className="flex flex-col h-screen bg-secondary w-20">
        ...
        <div className="mt-[94px] mx-5 flex flex-col gap-3">
          <NavigationButton className="w-10 h-10 rounded-[10px] bg-customBlue" />
          <NavigationButton className="w-10 h-10 rounded-[10px] bg-customBlue" />
          <NavigationButton className="w-10 h-10 rounded-[10px] bg-customBlue" />
          <NavigationButton className="w-10 h-10 rounded-[10px] bg-customBlue" />
          <NavigationButton className="w-10 h-10 rounded-[10px] bg-customBlue" />
        ...
        <div className="mt-auto mx-[15px] mb-8">
          <NavigationButton className="w-[50px] h-[50px] rounded-[100px] bg-customBlue flex items-center justify-center">
            <img
